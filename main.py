...
if __name__ == "__main__":
    ...
    a2_loc = "Costco in San Jose (2201 Senter Rd)"
    a2 = GasObj.get_gas_prices_by_station_id("489")
    resp = a2_loc + " : " + str(a2)
    slack_str += resp + "\n"

    a3_loc = "Costco in San Jose (1709 Automation Pkwy)"
    a3 = GasObj.get_gas_prices_by_station_id("35713")
    resp = a3_loc + " : " + str(a3)
    slack_str += resp + "\n"
